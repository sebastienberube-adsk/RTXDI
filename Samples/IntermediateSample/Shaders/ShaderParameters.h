...
#define VIS_MODE_RESERVOIR_WEIGHT    5
#define VIS_MODE_RESERVOIR_M         6
#define VIS_MODE_DIFFUSE_GRADIENT    7
#define VIS_MODE_SPECULAR_GRADIENT   8
#define VIS_MODE_GI_WEIGHT           9
#define VIS_MODE_GI_M                10
